...
typedef ino_t value_t;
typedef file_info* data_t;
...
// how to get the key
#define get_key(val) (val->inode_num)
...
// returns NULL if the operation was successful, the path of the conflict otherwise
char *hash_insert(const hash_table, const data_t);
